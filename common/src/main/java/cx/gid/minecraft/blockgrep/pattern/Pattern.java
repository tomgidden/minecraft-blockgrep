...
public final class Pattern
{
  ...
  private Pattern(int sizeX, int sizeY, int sizeZ, Predicate<BlockState>[] cells, String description, Optional<Set<Block>> candidateBlocks)
  {
    this.sizeX           = sizeX;
    this.sizeY           = sizeY;
    this.sizeZ           = sizeZ;
  ...
  public Optional<Set<Block>> candidateBlocks()
  {
      ...
      throws BlockPredicates.ParseException
  {
    ...
    return new Pattern(sizeX, sizeY, sizeZ, cells, desc, BlockPredicates.possibleBlocks(spec));
  }
      ...
      throws BlockPredicates.ParseException
  {
    ...
    Pattern pattern = new Pattern(sizeX, sizeY, sizeZ, cells, String.join(" || ", layerDescriptions), candidatesKnown ? Optional.of(candidates) : Optional.empty());
  ...
  public Pattern transformed(Symmetry.Transform transform)
  {
    ...
    return new Pattern(newSizeX, newSizeY, newSizeZ, moved, description, candidateBlocks);
  }
