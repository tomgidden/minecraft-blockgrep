 ...
 * rule which can be painted, copied and serialized back to Block Grep syntax.
 */
public final class EditablePattern
{
  ...
  private static void finishLayer(List<List<List<CellRule>>> layers, List<List<CellRule>> rows)
  {
    if(rows.isEmpty()) {
